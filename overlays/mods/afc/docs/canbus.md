...
> **Warning**: Setting up CAN bus and flashing MCUs over a CAN bus can be complicated. If you are unsure if you can do this without help, it would be better off to use additional MCUs via USB.
